...
const ContainerSettingOutline: React.FC<
...
> = props => {
  return (
    <svg
      ...
      height="1em">
      <path
        d="M7 15V9m4 6V9m4 6v-2m-3-9H2.4a.4.4 0 0 0-.4.4v15.2c0 .22.18.4.4.4h19.2a.4.4 0 0 0 .4-.4V13"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
...
export default ContainerSettingOutline
